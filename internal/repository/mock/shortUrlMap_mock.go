...
func (mr *MockShortUrlMapMockRecorder) FindOneByMd5(ctx, md5 interface{}) *gomock.Call {
...
func (mr *MockShortUrlMapMockRecorder) FindOneByShortUrl(ctx, shortUrl interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockShortUrlMapMockRecorder) Insert(ctx, data interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
